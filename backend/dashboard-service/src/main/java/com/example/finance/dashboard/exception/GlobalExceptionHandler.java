...
public class GlobalExceptionHandler {
  ...
  public ResponseEntity<ErrorResponse> handleCustomerNotFound(
    ...
    return buildErrorResponse(ex.getMessage(), ErrorCatalog.CUSTOMER_NOT_FOUND, request, null, false, ex);
  }

  @ExceptionHandler(DashboardAggregationException.class)
  public ResponseEntity<ErrorResponse> handleAggregation(
      DashboardAggregationException ex, HttpServletRequest request) {
    return buildErrorResponse(
        ErrorCatalog.DASHBOARD_AGGREGATION_FAILED.message(),
        ErrorCatalog.DASHBOARD_AGGREGATION_FAILED,
        request,
        null,
        false,
        ex);
