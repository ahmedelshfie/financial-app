...
public class GlobalExceptionHandler {
  ...
  public ResponseEntity<ErrorResponse> handleMissingServletRequestParameter(
    ...
    Map<String, String> details = new LinkedHashMap<>();
    details.put(ex.getParameterName(), ErrorCatalog.MISSING_REQUIRED_PARAMETER.message(ex.getParameterName()));

    return buildErrorResponse(
        ErrorCatalog.MISSING_REQUIRED_PARAMETER.message(ex.getParameterName()),
        ErrorCatalog.MISSING_REQUIRED_PARAMETER,
        request,
        details,
        false,
        ex);
