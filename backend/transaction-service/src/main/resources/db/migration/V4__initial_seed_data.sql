...
-- Transaction Service - Initial Seed Data
-- Description: Seeds transaction type data for recording all account transactions
-- ============================================================================

-- Seed transaction types
INSERT INTO transaction_db.transaction_types (code, name, category, description, is_debit) VALUES
