...
public enum ErrorCatalog {
  ACCOUNT_NOT_FOUND(
      "ACCOUNT_NOT_FOUND", "Account not found with id: %d", HttpStatus.NOT_FOUND, "MISSING_DATA"),
  INSUFFICIENT_FUNDS(
      "INSUFFICIENT_FUNDS",
      "Insufficient funds: the debit amount exceeds the available balance",
  ...
  ACCOUNT_TYPE_NOT_FOUND(
      "ACCOUNT_TYPE_NOT_FOUND", "Account type not found: %s", HttpStatus.BAD_REQUEST, "VALIDATION"),
